...
const transactionResolver = {
  ...
  Mutation: {
    createTransaction: async (_, { input }, context) => {
      try {
        ...
        // spread the input instead of putting all fields
    ...
    updateTransaction: async (_, { input }) => {
      try {
        const updatedTransaction = await Transaction.findByIdAndUpdate(
          ...
          // return the updated document and not the original
        );
  ...
  // relationship between transaction and user -> find user of a transaction
  Transaction: {
    user: async (parent) => {
